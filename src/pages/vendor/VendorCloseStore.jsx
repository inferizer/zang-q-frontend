...
export default function VendorCloseStore() {
  return (
    <div className="mobile:  justify-center items-center flex">
      <div className="mobile:w-[390px] h-[121px]  py-1 border-gray-200 flex-col justify-start items-start inline-flex">
        <div className="mobile:h-[113px] px-4 flex-col justify-start items-end gap-1 flex">
          <div className="mobile:ml-[80px] self-stretch px-6 py-3 rounded-xl justify-start items-center gap-[30px] inline-flex">
            ...
            <div className="mobile:grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
              ...
              <div className="mobile:justify-start items-start gap-2 inline-flex">
                <div className="mobile: ml-[29px] px-4 py-1 rounded-[40px] border border-pink-600 justify-end items-center flex">
          ...
          <div className="mobile:w-[390px] h-[533px] px-4 py-3 flex-col justify-start items-start gap-4 inline-flex">
            ...
            <div className="mobile:self-stretch justify-start items-center gap-8 inline-flex">
              <div className="mobile:grow shrink basis-0 px-4 py-1 rounded-2xl border border-gray-200 flex-col justify-start items-center inline-flex">
                <div className="mobile:w-[50px] h-[50px] relative">
                  <MdTableRestaurant className="mobile:w-[50px] h-[50px] text-[#E5E7EB]" />
                </div>
                <div className="mobile:text-gray-200 text-base font-normal font-['IBM Plex Sans Thai']">
                  1-2
                </div>
              </div>
              <div className="mobile:justify-start items-center gap-4 flex">
                  ...
                  <div className="mobile:rounded-2xl justify-center items-center gap-2 flex">
                    <div className="mobile:justify-center items-center flex">
                      <div className="mobile:px-2 rounded-tl-2xl rounded-bl-2xl flex-col justify-start items-center inline-flex">
                        <div className="mobile:text-gray-200 text-[32px] font-semibold font-['IBM Plex Sans Thai']">
                          A
                        </div>
                      </div>
                      <div className="mobile:px-4 rounded-tl-2xl rounded-bl-2xl border border-gray-200 flex-col justify-start items-center inline-flex">
                        <div className="mobile:text-gray-200 text-[32px] font-semibold font-['IBM Plex Sans Thai']">
                          0
                        </div>
                      </div>
                      <div className="mobile:px-4 rounded-tr-2xl rounded-br-2xl border border-gray-200 flex-col justify-start items-center inline-flex">
                        <div className="mobile:text-gray-200 text-[32px] font-semibold font-['IBM Plex Sans Thai']">
                          1
                        </div>
                      </div>
                ...
                <div className="mobile:justify-start items-center gap-2.5 flex">
                  <div className="mobile:justify-start items-start gap-2.5 flex">
                    <div className="mobile:bg-[#E5E7EB]   text-white rounded-[40px]  hover:text-white  hover:bg-gray-700">
            ...
            <div className="mobile:flex-col h-[50px] mx-auto my-auto justify-start items-start gap-2.5 flex">
              <div className="mobile:self-stretch  w-[360px] p-[10px]  rounded-lg border border-gray-200 flex-col justify-start items-center gap-2.5 flex">
                <div className="mobile:self-stretch text-center text-gray-200 text-base font-medium font-['IBM Plex Sans Thai'] leading-relaxed">
                  ดูประวัติคิว
                </div>
              </div>
            </div>
