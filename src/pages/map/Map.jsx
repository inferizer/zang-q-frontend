  ...
  return (
    <div className="flex flex-col py-5">
      ...
      <div className="flex justify-center">
        <button
          onClick={getLocation}
          className="flex justify-between items-center gap-2 mt-4 shadow bg-primary-500 hover:opacity-60 focus:shadow-outline focus:outline-none text-white font-medium py-2 px-6 rounded"
        >
