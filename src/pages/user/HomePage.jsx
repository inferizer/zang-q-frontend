...
export default function HomePage() {
	return (
		<>
			<header className="px-4 shadow-md z-30 bg-white fixed w-screen px-4 py-2 bottom-0 top-auto desktop:bottom-auto top-0">
				<div className="max-w-[800px] desktop:max-w-[1024px] m-auto flex justify-between items-center">
					<img src={logo} alt="logo" />
					<nav>
						<ul className='flex gap-4'>
							<li className="text-sm px-4 flex flex-col justify-center items-center"><img src={food}/>Home</li>
							<li className="text-sm px-4 flex flex-col justify-center items-center"><img src={map}/>Near</li>
							<li className="text-sm px-4 flex flex-col justify-center items-center"><img src={user}/>User</li>
						</ul>
					</nav>
				</div>
