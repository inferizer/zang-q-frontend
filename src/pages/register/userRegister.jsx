...
export default function UserRegister() {
  ...
  const { hdl_input, hdl_user_register_submit, input } = useAuth();
        ...
        <div className="mobile: justify-center items-center h-screen flex">
          <form className="mobile" onSubmit={hdl_submit}>
            ...
            <div className="mobile: border-[#BDBDBD] flex flex-col gap-2 items-start ">
              ...
              <input
                onChange={hdl_input}
                className={`mobile: w-[367px] border-solid border-2 mb-2 border-[#BDBDBD]${
                  error
                    ? "border-red-500 focus:ring-red-300"
                    : "focus:ring-blue-300 focus:border-blue-500 border-gray-300"
                }`}
